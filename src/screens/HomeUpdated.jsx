...
/**
 * HomeUpdated — the Today / dashboard screen just after logging the scanned
 * bowl (260 kcal) as Dinner. Identical to Home, with updated numbers (Dinner
 * 260 kcal / 1 item, 1,415 of 2,200 kcal total) and a success toast confirming
 * the action, above the bottom navigation. All numbers are IBM Plex Mono.
 */
...
// After logging: Breakfast (515) + Lunch (640) + Dinner (260) = 1,415 kcal. Snacks empty.
const meals = [
      ...
      <div className="relative w-[390px] h-[844px] rounded-[44px] border-[8px] border-neutral-800 shadow-2xl overflow-hidden bg-background flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden pb-44">
          ...
          <div className="px-6 pt-4">
            ...
            >
              <CalorieRing value={64} current={1415} total={2200} size="lg" />
        ...
        {/* Success toast — "Lunch logged." (above the bottom nav) */}
        <div className="absolute inset-x-0 bottom-[148px] z-10 flex justify-center px-5">
          <Toast
            variant="success"
