...
/**
 * WFHome — wireframe for the Home / Today screen.
 *
 * Structure only, no brand colors. 375px mobile frame: status bar, a "Today"
 * app bar, a unified dashboard widget (eaten / remaining ring / burned + macro
 * bars), a stack of meal cards, a fixed "Scan meal" FAB above a fixed bottom
 * navigation. FAB/nav are positioned absolute within the frame (the spec's
 * "fixed" intent, scoped to the mock device).
 */
...
export default function WFHome() {
  return (
        ...
        <div className="relative w-[375px] h-[760px] bg-white border border-gray-300 rounded-sm overflow-hidden flex flex-col">
          ...
          <div className="flex-1 overflow-auto pb-40">
            ...
            <div className="mx-5 mt-4 bg-white border border-gray-200 rounded-lg p-4">
              ...
              {/* Bottom row — macro horizontal bars */}
